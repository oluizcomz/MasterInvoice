...
namespace MasterInvoice.Services
{
    public class InvoiceService : IInvoice
    {
        ...
        {
            using var _context = new ContextBase(optionsBuilder);
            IQueryable<Invoices> query = _context.Invoices;
            ...
            if (PaymentDate != null)
                query = query.Where(i => _context.Payments.Any(p => p.InvoiceId == i.Id && p.PaymentDate >= PaymentDate && p.PaymentDate < PaymentDate.Value.AddMonths(1)));
